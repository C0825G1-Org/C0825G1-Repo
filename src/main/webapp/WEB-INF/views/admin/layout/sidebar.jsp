<%@ page contentType="text/html;charset=UTF-8" language="java" %>
    <%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
        ...
        <div class="bg-light border-end vh-100 sticky-top" style="width: 250px;">
            <div class="p-3">
                <h6 class="text-muted text-uppercase small mb-3">Management</h6>
                <ul class="nav flex-column">
                    <li class="nav-item mb-2">
                        <a class="nav-link ${pageContext.request.requestURI.contains('/admin/rooms') ? 'active bg-primary text-white' : 'text-dark'} rounded"
                            href="${pageContext.request.contextPath}/admin/rooms">
                            <i class="bi bi-door-open"></i> Room Management
                        </a>
                    </li>
                    <li class="nav-item mb-2">
                        <a class="nav-link ${pageContext.request.requestURI.contains('/admin/bookings') ? 'active bg-primary text-white' : 'text-dark'} rounded"
